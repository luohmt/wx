...
class AccountInfo(models.Model):
    biz = models.CharField(db_column='BIZ', primary_key=True, max_length=255)  # Field name made lowercase.
...
class AccountType(models.Model):
    actype_id = models.IntegerField(primary_key=True)
    actype_nm = models.CharField(max_length=100, blank=True, null=True)
...
class ArticleType(models.Model):
    article_type_id = models.IntegerField(primary_key=True)
    article_type_nm = models.CharField(max_length=255, blank=True, null=True)
...
class Subject(models.Model):
    ...
    sub_nm = models.CharField(max_length=100, blank=True, null=True)
...
class Test(models.Model):
    a = models.CharField(primary_key=True, max_length=255)
...
class WarnArticle(models.Model):
    url = models.CharField(db_column='URL', max_length=255, blank=True, null=True)  # Field name made lowercase.
    title = models.CharField(max_length=100, blank=True, null=True)
    biz = models.CharField(db_column='BIZ', primary_key=True, max_length=255)  # Field name made lowercase.
    nickname = models.CharField(max_length=255, blank=True, null=True)
